...
const locations = [
  {
    ...
    address: 'Blvd. del Hipódromo #123, Colonia San Benito',
    city: 'San Salvador',
    phone: '+503 2222-3333',
    hours: {
    ...
    features: ['Outdoor Patio', 'Full Bar', 'Private Events', 'Free WiFi', 'Parking'],
  ...
  },
  {
    ...
    address: 'Paseo General Escalón #456, Colonia Escalón',
    city: 'San Salvador',
    phone: '+503 2222-4444',
    hours: {
    ...
    features: ['Family Friendly', 'Takeout Window', 'Free WiFi', 'Street Parking'],
