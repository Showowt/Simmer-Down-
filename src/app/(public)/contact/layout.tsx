...
export const metadata: Metadata = {
  ...
  description:
    "Contacta a Simmer Down. Reservaciones, eventos privados, catering y consultas. Santa Ana: +503 7680-4434. San Benito: +503 7487-7792. Coatepeque: +503 6831-6907. WhatsApp disponible.",
  keywords: [
  ...
  twitter: {
    ...
    description: "Reservaciones y eventos. +503 7680-4434 | WhatsApp disponible.",
