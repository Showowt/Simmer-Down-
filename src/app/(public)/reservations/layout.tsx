...
export const metadata: Metadata = {
  ...
  description:
    'Reserva tu mesa en Simmer Down, la mejor pizzería de El Salvador. 5 ubicaciones disponibles: Santa Ana, Lago de Coatepeque, San Benito (San Salvador), Juayúa y Surf City. Reserva en línea o llama al +503 7680-4434.',
  keywords: [
