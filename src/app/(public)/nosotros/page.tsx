...
const MILESTONES = [
  {
    ...
    descEs: 'Simmer Down abre en Santa Ana, Centro historico de Santa Ana.',
    descEn: 'Simmer Down opens in Santa Ana, in the historic city center.',
  },
  {
    year: '2021',
    titleEs: 'Simmer Garden',
    titleEn: 'Simmer Garden',
    descEs: 'Simmer Garden abre en San Jose La Majada, Ruta de las Flores.',
    descEn: 'Simmer Garden opens in San Jose La Majada, Ruta de las Flores.',
  },
  {
    year: '2022',
    titleEs: 'San Salvador, Col. San Benito',
    titleEn: 'San Salvador, Col. San Benito',
    descEs: 'Expansion a San Salvador, Col. San Benito (Venue).',
    descEn: 'Expansion to San Salvador, Col. San Benito (Venue).',
  },
  {
    year: '2025',
    titleEs: 'Lago de Coatepeque',
    titleEn: 'Lake Coatepeque',
    descEs: 'Una Joya. El lago de Coatepeque y nace Simmer Down.',
    descEn: 'A gem. Lake Coatepeque and Simmer Down is born.',
  },
  {
    year: '2025',
    titleEs: 'Surf City',
    titleEn: 'Surf City',
    descEs: 'Simmer Down Surf City, nuestra ultima ubicacion frente al mar.',
    descEn: 'Simmer Down Surf City, our latest location by the sea.',
  },
]
