  ...
  return (
    <div className="sticky top-16 z-40 bg-[#1A1A1A] border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-2.5 flex items-center justify-between gap-3 min-h-[44px]">
        ...
        >
          ...
          {selectedLocation ? (
            <span className="flex items-center gap-2 min-w-0">
              ...
              <span className="text-[13px] font-semibold text-white truncate max-w-[140px] sm:max-w-[220px]">
        ...
        <div
          className="flex items-center bg-white/[0.06] rounded-lg p-0.5 shrink-0"
          role="group"
