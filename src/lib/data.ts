...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'pescatore', categoryId: 'specialty-pizzas', name: 'La Pescatore', nameEs: 'La Pescatore', description: 'Calamari, clams, shrimp, purple onion and marinated peppers', descriptionEs: 'Calamar, almejas, camarones, cebolla morada y pimientos marinados', basePrice: 6.25, image: '/images/menu/food-IMG20060.jpg', isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false, sizes: SPECIALTY_PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  { id: 'punta-jalapena', categoryId: 'specialty-pizzas', name: 'Punta Jalapeña', nameEs: 'Punta Jalapeña', description: 'Beef tenderloin, mozzarella, fresh cilantro and our delicious Punta Jalapeña sauce', descriptionEs: 'Lomito de res, mozzarella, cilantro fresco y nuestra deliciosa salsa Punta Jalapeña', basePrice: 6.25, image: '/images/menu/food-IMG20063.jpg', isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: true, isGlutenFree: false, isNew: false, sizes: SPECIALTY_PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  ...
  { id: 'cheese-balls', categoryId: 'starters', name: 'Cheese Balls', nameEs: 'Bolitas de Queso', description: 'Crispy mixed cheese balls with pomodoro sauce and garlic bread', descriptionEs: 'Bolitas de mix de quesos con salsa pomodoro y pan con ajo', basePrice: 6.99, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
