...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'brazuca', categoryId: 'pizzas', name: 'Brazuca', nameEs: 'Brazuca', description: 'Pineapple and salami with golden sauce and jalapeños', descriptionEs: 'Piña y salami con salsa dorada del chef y jalapeños', basePrice: 5.75, image: '/images/menu/pizzas-hero.jpg', isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: true, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  ...
  // STARTERS
  { id: 'leche-tigra', categoryId: 'starters', name: "Leche d'Tigra", nameEs: "Leche d'Tigra", description: 'Fish ceviche, sweet potato, baby corn, red onion, cilantro, lime, plantain chips', descriptionEs: 'Pescado, camote glaseado, elotitos, cebolla morada, cilantro, jugo de limón, tajadas de plátano', basePrice: 13.99, image: '/images/menu/pro-IMG4591.jpg', isAvailable: true, isFeatured: true, isVegetarian: false, isSpicy: false, isGlutenFree: true, isNew: false },
