...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'maradona', categoryId: 'pizzas', name: 'Maradona', nameEs: 'Maradona', description: 'A Tribute to a Legend! Top-Tier Argentinian Chorizo, Green Peppers, Onions', descriptionEs: '¡Un Tributo a una Leyenda! Chorizo Argentino de Primera, Pimientos Verdes, Cebollas', basePrice: 5.75, image: '/images/menu/pizza-memoravel.jpg', isAvailable: true, isFeatured: true, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  ...
  { id: 'ham-pepperoni', categoryId: 'pizzas', name: 'Ham or Pepperoni', nameEs: 'Jamón o Pepperoni', description: 'Traditional Ham or Pepperoni Pizza', descriptionEs: 'Pizza Tradicional de Jamón o Pepperoni', basePrice: 5.75, isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  ...
  { id: 'quattro-cheeses', categoryId: 'pizzas', name: 'QU4TRO Cheeses', nameEs: 'QU4TRO Quesos', description: 'Criollo Cheese, Parmesan, Mozzarella, Cream Cheese and Basil', descriptionEs: 'Queso Criollo, Parmesano, Mozzarella, Queso Crema y Albahaca', basePrice: 5.75, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  { id: 'mella-green', categoryId: 'pizzas', name: 'Mella Green', nameEs: 'Mella Green', description: 'Grilled Chicken Fajitas, Green Apple, Almond Slices and Bacon', descriptionEs: 'Fajitas de Pollo a la Parrilla, Manzana Verde, Rodajas de Almendra y Tocino', basePrice: 5.75, isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },

  // SPECIALTY PIZZAS
  { id: 'ghiottone', categoryId: 'specialty-pizzas', name: 'Ghiottone', nameEs: 'Ghiottone', description: 'Peppers, Onion, Tomato, Salami, Ham, Pepperoni, Chorizo, Olives and Mushrooms', descriptionEs: 'Pimientos, Cebolla, Tomate, Salami, Jamón, Pepperoni, Chorizo, Aceitunas y Hongos', basePrice: 6.25, image: '/images/menu/food-IMG20042.jpg', isAvailable: true, isFeatured: true, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  ...
  { id: 'mr-krabs', categoryId: 'specialty-pizzas', name: 'Mr. Krabs', nameEs: 'Don Cangrejo', description: 'Fresh shrimp and marinated clams, onion, green peppers, capers', descriptionEs: 'Camarones frescos y almejas marinadas, cebolla, pimientos, alcaparras', basePrice: 6.25, isAvailable: true, isFeatured: true, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  { id: 'peasant-woman', categoryId: 'specialty-pizzas', name: 'The Peasant Woman', nameEs: 'La Campesina', description: 'Beef fajitas, Iberian chorizo, mozzarella, refried beans, salsa and cream', descriptionEs: 'Fajitas de res, chorizo ibérico, mozzarella, frijoles refritos, salsa y crema', basePrice: 6.25, isAvailable: true, isFeatured: true, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  ...
  // MAINS
  { id: 'lomito-maitre', categoryId: 'mains', name: 'Terramar al Maitre', nameEs: 'Terramar al Maitre', description: 'Tenderloin with jumbo shrimp, maitre butter, seasonal vegetables', descriptionEs: 'Lomito con camarones jumbo, mantequilla maitre, vegetales de temporada', basePrice: 17.75, image: '/images/menu/pro-IMG4591.jpg', isAvailable: true, isFeatured: true, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false },
  ...
  { id: 'frozen', categoryId: 'drinks', name: 'Frozen', nameEs: 'Frozen', description: 'Pineapple, Strawberry & Mint, Positive Vibration', descriptionEs: 'Piña, Fresa y Menta, Vibra Positiva', basePrice: 3.75, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: true, isNew: false },
  { id: 'pilsener', categoryId: 'drinks', name: 'Pilsener', nameEs: 'Pilsener', basePrice: 2.25, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: true, isNew: false },
