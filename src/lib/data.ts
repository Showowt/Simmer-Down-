...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'pescatore', categoryId: 'specialty-pizzas', name: 'La Pescatore', nameEs: 'La Pescatore', description: 'Calamari, clams, shrimp, purple onion and marinated peppers', descriptionEs: 'Calamar, almejas, camarones, cebolla morada y pimientos marinados', basePrice: 6.25, isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false, sizes: SPECIALTY_PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  { id: 'punta-jalapena', categoryId: 'specialty-pizzas', name: 'Punta Jalapeña', nameEs: 'Punta Jalapeña', description: 'Beef tenderloin, mozzarella, fresh cilantro and our delicious Punta Jalapeña sauce', descriptionEs: 'Lomito de res, mozzarella, cilantro fresco y nuestra deliciosa salsa Punta Jalapeña', basePrice: 6.25, isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: true, isGlutenFree: false, isNew: false, sizes: SPECIALTY_PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
  ...
  { id: 'cheesecake-fresa', categoryId: 'desserts', name: 'Strawberry Cheesecake', nameEs: 'Cheesecake de Fresa', basePrice: 3.99, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  ...
  // LOCAL BEERS
  { id: 'heroica', categoryId: 'local-beers', name: 'Cerveza Artesanal Heroica', nameEs: 'Cerveza Artesanal Heroica', description: 'Craft beer from Cervecería Santaneca Puente Quemado', descriptionEs: 'Cervecería Santaneca Puente Quemado', basePrice: 5.00, isAvailable: true, isFeatured: true, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  ...
  en: {
    ...
    'hero.badge': 'EST. 2014 • EL SALVADOR', 'hero.title': 'HANDCRAFTED PIZZA', 'hero.titleAccent': 'GOOD VIBES ONLY', 'hero.subtitle': 'Artisan wood-fired pizza crafted with love. Experience the perfect blend of tradition and local flavor across our 5 locations.', 'hero.viewMenu': 'View Menu', 'hero.findLocations': 'Find Locations',
