...
export const MENU_ITEMS: MenuItem[] = [
  ...
  // STARTERS
  { id: 'leche-tigra', categoryId: 'starters', name: "Leche d'Tigra", nameEs: "Leche d'Tigra", description: 'Fish ceviche, sweet potato, baby corn, red onion, cilantro, lime, plantain chips', descriptionEs: 'Pescado, camote glaseado, elotitos, cebolla morada, cilantro, jugo de limón, tajadas de plátano', basePrice: 13.99, isAvailable: true, isFeatured: true, isVegetarian: false, isSpicy: false, isGlutenFree: true, isNew: false },
  ...
  { id: 'aguachile', categoryId: 'starters', name: 'Aguachile de Camarón', nameEs: 'Aguachile de Camarón', description: 'Shrimp in aguachile sauce, red onion, cucumber, cilantro, jalapeño, celery, plantain chips', descriptionEs: 'Camarón en salsa aguachile, cebolla morada, pepino, cilantro, chile jalapeño, apio, tajadas de plátano', basePrice: 11.99, image: '/images/menu/entradas-seafood-trio.jpg', isAvailable: true, isFeatured: true, isVegetarian: false, isSpicy: true, isGlutenFree: true, isNew: false },
  { id: 'cheese-balls', categoryId: 'starters', name: 'Cheese Balls', nameEs: 'Bolitas de Queso', description: 'Crispy mixed cheese balls with pomodoro sauce and garlic bread', descriptionEs: 'Bolitas de mix de quesos con salsa pomodoro y pan con ajo', basePrice: 6.99, image: '/images/menu/entradas-cheese-balls.jpg', isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'chicken-chunks', categoryId: 'starters', name: 'Chicken Chunks', nameEs: 'Chunks de Pollo', description: 'Breaded chicken breast pieces with french fries', descriptionEs: 'Trozos de pechugas empanizados con papas francesas', basePrice: 5.99, image: '/images/menu/food-IMG20051.jpg', isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'potatoes-bacon', categoryId: 'starters', name: 'Potatoes with Bacon', nameEs: 'Papas con Tocino', basePrice: 5.99, image: '/images/menu/food-IMG20052.jpg', isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'shrimp-chicken-melt', categoryId: 'starters', name: 'Shrimp and Chicken Melt', nameEs: 'Melt de Camarón y Pollo', basePrice: 7.99, image: '/images/menu/food-IMG20048.jpg', isAvailable: true, isFeatured: false, isVegetarian: false, isSpicy: false, isGlutenFree: false, isNew: false },
  ...
  { id: 'cheesecake-fresa', categoryId: 'desserts', name: 'Strawberry Cheesecake', nameEs: 'Cheesecake de Fresa', basePrice: 3.99, image: '/images/menu/product-01.jpg', isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'panna-cotta', categoryId: 'desserts', name: 'Panna Cotta', nameEs: 'Panna Cotta', description: 'Classic Italian panna cotta with mixed berry compote', descriptionEs: 'Panna Cotta clásica con compota de frutos rojos', basePrice: 3.99, image: '/images/menu/panna-cotta.jpg', isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: true, isNew: false },
  ...
  { id: 'regia-chola', categoryId: 'local-beers', name: 'Regia Chola', nameEs: 'Regia Chola', basePrice: 4.25, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'suprema', categoryId: 'local-beers', name: 'Suprema', nameEs: 'Suprema', basePrice: 2.50, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  ...
  { id: 'golden', categoryId: 'local-beers', name: 'Golden', nameEs: 'Golden', basePrice: 2.25, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'golden-extra', categoryId: 'local-beers', name: 'Golden Extra', nameEs: 'Golden Extra', basePrice: 2.25, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },

  // IMPORTED BEERS
  { id: 'corona', categoryId: 'imported-beers', name: 'Corona', nameEs: 'Corona', basePrice: 3.50, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'heineken', categoryId: 'imported-beers', name: 'Heineken', nameEs: 'Heineken', basePrice: 3.50, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'michelob-ultra', categoryId: 'imported-beers', name: 'Michelob Ultra', nameEs: 'Michelob Ultra', basePrice: 3.50, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
  { id: 'gallo', categoryId: 'imported-beers', name: 'Gallo', nameEs: 'Gallo', basePrice: 3.50, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false },
];
