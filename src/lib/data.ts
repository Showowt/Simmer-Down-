...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'margherita', categoryId: 'pizzas', name: 'Margherita', nameEs: 'Margherita', description: 'Mozzarella, Marinated Cherry Tomatoes and Fresh Basil', descriptionEs: 'Mozzarella, Tomates Cherry Marinados y Albahaca Fresca', basePrice: 5.75, isAvailable: true, isFeatured: false, isVegetarian: true, isSpicy: false, isGlutenFree: false, isNew: false, sizes: PIZZA_SIZES, modifiers: PIZZA_MODIFIERS },
